...
namespace Charites.Windows.Forms
{
    ...
    {
        ContentControl ContentControl { get; } = new ContentControl();

        TestDataContexts.TestContent Content { get; } = new TestDataContexts.TestContent();
        TestDataContexts.DerivedTestContent DerivedContent { get; } = new TestDataContexts.DerivedTestContent();
        TestDataContexts.EmptyContent EmptyContent { get; } = new TestDataContexts.EmptyContent();

        TestControls.TestControl ContentView { get; set; }
        ...
        void Ex01()
        {
            ...
            ContentView = ContentControl.Controls[0] as TestControls.TestControl;
            ...
            Then("the data context of the new content view should be set", () =>
                ContentControl.Controls.OfType<TestControls.TestControl>().FirstOrDefault().DataContext == DerivedContent
            );
