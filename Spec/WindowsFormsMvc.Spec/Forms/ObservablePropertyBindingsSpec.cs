...
{
    ObservablePropertyBindings ObservablePropertyBindings { get; } = new();
    ...
    TestControls.TestControl TestControl { get; } = new()
    {
    ...
    {
        NameBoundProperty = BoundProperty<string>.By(NameProperty);
        TextBoundProperty = BoundProperty<int>.By(TextProperty);
    }
