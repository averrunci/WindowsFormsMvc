...
[Context("The checked member is specified")]
class ListViewItemsSourceSpec_CheckedMemberSpecified : ItemsSourceSpecContext<ListView, TestItem>
{
    ListView ListView { get; } = new() { CheckBoxes = true };
    ...
    public ListViewItemsSourceSpec_CheckedMemberSpecified()
    {
