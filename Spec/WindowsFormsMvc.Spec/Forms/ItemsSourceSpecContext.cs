...
{
    protected ItemsSource<TControl, TItem> ItemsSource { get; set; } = default!;

    protected TestItem[] InitialItems { get; set; } = default!;
    protected ObservableCollection<TestItem> Items { get; set; } = default!;
