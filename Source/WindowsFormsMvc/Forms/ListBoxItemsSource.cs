...
namespace Charites.Windows.Forms
{
    ...
    public class ListBoxItemsSource : ItemsSource<ListBox>
    {
        ...
        /// <paramref name="listBox"/> is <c>null</c>.
        /// </exception>
    ...
    public class ListBoxItemsSource<TItem, TValue> : ValuedItemsSource<ListBox, TItem, TValue>
    {
        /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TItem">The type of the item.</typeparam>
    public class ListBoxItemsSource<TItem> : ListBoxItemsSource<TItem, string>
    {
        /// <summary>
