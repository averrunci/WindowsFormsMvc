...
namespace Charites.Windows.Forms
{
    ...
    public class ComboBoxItemsSource : ItemsSource<ComboBox>
    {
        ...
        /// <paramref name="comboBox"/> is <c>null</c>.
        /// </exception>
    ...
    public class ComboBoxItemsSource<TItem, TValue> : ValuedItemsSource<ComboBox, TItem, TValue>
    {
        /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TItem">The type of the item.</typeparam>
    public class ComboBoxItemsSource<TItem> : ComboBoxItemsSource<TItem, string>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ComboBoxItemsSource{TItem,TValue}"/> class
