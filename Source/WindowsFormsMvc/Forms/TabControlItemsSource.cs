...
namespace Charites.Windows.Forms
{
    ...
    public class TabControlItemsSource : ItemsSource<TabControl>
    {
        ...
        /// <paramref name="tabControl"/> is <c>null</c>.
        /// </exception>
        ...
        protected string GetHeader(object item)
            => HeaderMember == null ? item?.ToString() : item?.GetType().GetProperty(HeaderMember)?.GetValue(item) as string;
    }
    ...
    public class TabControlItemsSource<TItem> : ValuedItemsSource<TabControl, TItem, string>
    {
        ...
        /// </exception>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="headerSelector"/> is <c>null</c>.
        /// </exception>
