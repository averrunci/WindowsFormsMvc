...
{
    private static readonly ConditionalWeakTable<Control, IDictionary<object, EventHandlerBase<Control, WindowsFormsEventHandlerItem>>> EventHandlerBaseRepository = new();
    ...
    {
        if (element is null) return new Dictionary<object, EventHandlerBase<Control, WindowsFormsEventHandlerItem>>();
